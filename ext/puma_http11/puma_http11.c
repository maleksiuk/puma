...
#ifndef CONFIGURED_QUERY_STRING_MAX_LENGTH
#define CONFIGURED_QUERY_STRING_MAX_LENGTH (1024 * 10)
#endif
...
DEF_MAX_LENGTH(QUERY_STRING, CONFIGURED_QUERY_STRING_MAX_LENGTH);
